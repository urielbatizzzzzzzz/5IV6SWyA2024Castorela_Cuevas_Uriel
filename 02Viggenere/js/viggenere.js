...
const longCif=document.getElementById('logcifrar');
const longDecif=document.getElementById('logdescifrar');


vigenereRadio.addEventListener("change", function () {
    desplazamiento.disabled = true;
    longCif.disabled=false;
    longDecif.disabled=false;
});
